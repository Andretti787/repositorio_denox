					...
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
                            	...
                            	<section>
									<header class="main">
										<h1>4.3.5.4. Asignación TEST</h1>
									</header>
<?php
if (isset($respuesta)){
														echo '<br><div class="alert"><h2><i class="fas fa-info-circle"> </i> '.$mensajedevuelto.'</h2></div>  <button style = "width:100%" class="col-12 primary" onclick="window.location.href=\'/indexTest.php\'">Continuar</button>';

}else{
?>
									<!-- Content -->
										<!--<h2 id="content">Sample Content</h2>-->
										<p><form method="get" action="indexTEST.php">
